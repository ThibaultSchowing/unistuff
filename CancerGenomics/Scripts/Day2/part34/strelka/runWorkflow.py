#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/software/UHTS/Analysis/strelka/2.9.6/bin/configureStrelkaSomaticWorkflow.py --tumorBam /data/courses/cancergenomics/SomaticVariantCalling_CancerGenomics_2019/dedup/Case_001_T.coordSorted.rg.dedup.bam --normalBam /data/courses/cancergenomics/SomaticVariantCalling_CancerGenomics_2019/dedup/Case_001_N.coordSorted.rg.dedup.bam --referenceFasta /data/courses/cancergenomics/SomaticVariantCalling_CancerGenomics_2019/reference/Homo_sapiens.GRCh38.dna.primary_assembly.fa --callRegions /data/courses/cancergenomics/SomaticVariantCalling_CancerGenomics_2019/targets/KRAS_TP53_CDKN2C_targets_GRCh38.bed.gz --exome --runDir ./strelka'
#
...
sys.path.append(r'/software/UHTS/Analysis/strelka/2.9.6/lib/python')
...
main(r"/data/users/student06/day2/part34/strelka/runWorkflow.py.config.pickle","StrelkaSomatic",StrelkaSomaticWorkflow)
