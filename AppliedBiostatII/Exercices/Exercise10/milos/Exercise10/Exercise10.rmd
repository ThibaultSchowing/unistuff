...
The two plots demonstrate a poor fit. In the Tukey Anscombe plot standard deviation increases with increasing the response variable, while the qqPlot is right skewed. This indicates that we should try a log transform.
